...
export default function Signup() {
  ...
  const [form, setForm] = useState({ username: '', fullName: '', email: '', password: '', goal: GOALS[4] })
    ...
    <div className="flex min-h-screen flex-col justify-center bg-base-950 py-12 px-4 overflow-y-auto">
      <div className="mx-auto w-full max-w-sm animate-fadeUp">
        <div className="mb-6 flex flex-col items-center text-center">
          ...
          <h1 className="font-display text-xl font-bold tracking-tight text-white">Create your account</h1>
          <p className="mt-1 text-xs text-zinc-500">Start building habits that compound</p>
        </div>
        ...
        <div className="border border-zinc-800 bg-base-800 p-6 rounded-md">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="label-text">What's your main goal?</label>
              <select
                className="input-field"
                value={form.goal}
